...
<script>
  ...
  import FinancieraForm from "@/components/contratoprestamo/registro/financiera/FinancieraForm"
  import FinancieraTable from "@/components/contratoprestamo/registro/financiera/FinancieraTable"
  export default {
    components: {
      FinancieraForm,
      FinancieraTable
